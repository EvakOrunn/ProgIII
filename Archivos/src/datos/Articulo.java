...
public class Articulo implements Grabable {
    ...
    // descripcion 100 bytes + codigo de artico 4 bytes + codigo de rubro 4 bytes +
    // precio 4 bytes
    // este calculo debe realizarse para toda clase que pase file integrar un
    // registro
    // de archivo
    ...
    public void mostrarRegistro() {
        ...
        System.out.println(String.format("| %6d | %-50s | %10d | $%8.2f |", codigo, descripcion, codRubro, precio));
    }
    ...
    public void cargarDatos() {
        ...
        do {
        System.out.print("Codigo de rubro--> ");
        codRubro = Consola.readInt();
        } while (codRubro < 0);
        do {
